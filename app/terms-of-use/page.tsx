          ...
          <div className="prose prose-lg dark:prose-invert space-y-12 text-muted-foreground">
            <AnimatedSection>
              <section id="introduction">
                ...
                <p>
                  ...
                  <a href="https://quantum-eur.pl" className="text-primary hover:underline">https://quantum-eur.pl</a>{" "}
                  (the “Website”), operated by MICROMEGAS Spółka z ograniczoną odpowiedzialnością (the “Company”, “we”, “us”, or “our”).
                </p>
                <p>
            ...
            <AnimatedSection>
              <section id="nature-of-website">
                <h2 className="text-3xl font-bold text-foreground mb-4">2. Nature of the Website</h2>
                <p>
            ...
            <AnimatedSection>
              <section id="use-of-website">
                <h2 className="text-3xl font-bold text-foreground mb-4">3. Use of the Website</h2>
            ...
            <AnimatedSection>
              <section id="no-professional-advice">
                <h2 className="text-3xl font-bold text-foreground mb-4">4. No Professional or Technical Advice</h2>
                <p>
            ...
            <AnimatedSection>
              <section id="intellectual-property">
                <h2 className="text-3xl font-bold text-foreground mb-4">5. Intellectual Property and Third-Party Materials</h2>
                <p>
            ...
            <AnimatedSection>
              <section id="accuracy-of-information">
                <h2 className="text-3xl font-bold text-foreground mb-4">6. Accuracy of Information</h2>
                <p>
            ...
            <AnimatedSection>
              <section id="no-warranties">
                <h2 className="text-3xl font-bold text-foreground mb-4">7. No Warranties</h2>
                <p>
            ...
            <AnimatedSection>
              <section id="services-and-commercial-terms">
                <h2 className="text-3xl font-bold text-foreground mb-4">9. Services and Commercial Terms</h2>
            ...
            <AnimatedSection>
              <section id="logistics-disclaimer">
                <h2 className="text-3xl font-bold text-foreground mb-4">10. Logistics and International Trade Disclaimer</h2>
            ...
            <AnimatedSection>
              <section id="third-party-links">
                <h2 className="text-3xl font-bold text-foreground mb-4">11. Third-Party Links and Services</h2>
                <p>
            ...
            <AnimatedSection>
              <section id="personal-data">
                <h2 className="text-3xl font-bold text-foreground mb-4">12. Personal Data</h2>
                <p>
            ...
            <AnimatedSection>
              <section id="changes-to-terms">
                <h2 className="text-3xl font-bold text-foreground mb-4">14. Changes to the Terms</h2>
                <p>
            ...
            <AnimatedSection>
              <section id="governing-law">
                <h2 className="text-3xl font-bold text-foreground mb-4">15. Governing Law and Jurisdiction</h2>
                <p>
            ...
            <AnimatedSection>
              <section id="contact-information">
                ...
                <div className="bg-muted/30 p-8 rounded-2xl border">
                  <p className="font-bold text-foreground mb-2">MICROMEGAS Spółka z ograniczoną odpowiedzialnością</p>
                  <p>Plac Bankowy 2, lok. 1309, 00-095 Warszawa, Poland</p>
                  <p>NIP: 5273007007</p>
                  <p className="mt-4">
                    Email: <a href="mailto:info@micro-megas.com" className="text-primary hover:underline">info@micro-megas.com</a>
                  </p>
                </div>
              </section>
            </AnimatedSection>
